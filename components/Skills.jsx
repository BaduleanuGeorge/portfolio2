  ...
  return (
    <div className="flex flex-col items-center justify-center sm:flex-row sm:mx-2">
      <div className="pb-4 max-w-[450px] mx-4">
        <p className="text-justify">These technologies make up my skillset. Although I have no industrial experience using any of them, I have used them to achieve commercial experience.</p>
        <p>Moreover, I'm learning React and Tailwind to help me in my journey of becoming a Front End Developer.
        </p>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:mx-4 flex-shrink-0">
        <div className="flex flex-col justify-center items-center w-[90px] h-[100px] border border-black/25 bg-gray-200 rounded-md shadow-sm shadow-black/50">
